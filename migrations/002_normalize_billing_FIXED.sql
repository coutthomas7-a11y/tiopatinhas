-- Migration 002: Normalização do Sistema de Billing (CORRIGIDA)
-- Data: 2025-12-19
...
-- ============================================================================
-- 4. ATUALIZAR TABELA PAYMENTS (Adicionar colunas faltando)
-- ============================================================================
...
-- ============================================================================
-- 5. ATUALIZAR TABELA USERS (Adicionar novos planos)
-- ============================================================================

-- Remover constraint antigo de planos (se existir)
...
LEFT JOIN users u ON u.id = p.user_id  -- Fallback para pagamentos antigos
LEFT JOIN subscriptions s ON s.id = p.subscription_id
ORDER BY p.created_at DESC;

-- ============================================================================
-- 8. ADICIONAR CAMPO usage_type na tabela ai_usage (se não existir)
-- ============================================================================

-- Verificar e adicionar campo usage_type
ALTER TABLE ai_usage
  ADD COLUMN IF NOT EXISTS usage_type VARCHAR(50);

-- Migrar operation_type para usage_type (se necessário)
UPDATE ai_usage
SET usage_type = operation_type
...
BEGIN
  ...
  RAISE NOTICE '📊 Tabela atualizada: payments (+ 6 colunas)';
  RAISE NOTICE '📊 Tabela atualizada: users (planos atualizados)';
